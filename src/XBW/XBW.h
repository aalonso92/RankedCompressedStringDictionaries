...
public:
	...
	/** Builds the XBW from the given parameters:
	 * @param nodesCount
	 * @param mapping
	 * @param alphaInt
	 * @param lastInt
	 * @param AInt
	 * @param sparse_bitsequence tells the type of bitsequence used in the structure.
	 * @param bparam param value for the chosen bitsequence.
	 */
	void build(uint nodesCount, uint *mapping, uint *alphaInt, uint *lastInt, uint *AInt,  bool sparse_bitsequence, int bparam);
