...
StringDictionaryHASHRPF::StringDictionaryHASHRPF(IteratorDictString *it, uint len, int overhead, int encoding)
{
	this->type = HASHRPF;
	this->elements = 0;
	this->maxlength = 0;
